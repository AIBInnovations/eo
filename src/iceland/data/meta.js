/** Per-page titles and descriptions (also used for Open Graph / Twitter cards). */
export const SITE_URL = 'https://eo-delta-henna.vercel.app';
...
export const pageMeta = {
  ...
  terms: { title: 'Terms of Use · Iceland 2027', description: 'Terms for using the EO Punjab Iceland 2027 retreat website.' },
  'thank-you': { title: 'Thank you · Iceland 2027', description: 'Your enquiry has reached the retreat desk.' },
  'not-found': { title: 'Page not found · Iceland 2027', description: 'That page is not on the itinerary.' },
};
